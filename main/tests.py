...
class OtpTestCase(TestCase):
    ...
    def test_otp_mail(self):
        self.assertEqual(Otp.objects.get(mail="nobody@example.com").mail, "nobody@example.com")
        self.assertEqual(Otp.objects.get(mail="nobody1@example.com").mail, "nobody1@example.com")
